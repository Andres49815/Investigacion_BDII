...
namespace CountriesApp.Controllers
{
    public class CountriesController : Controller
    {
        ...
        private static string connectionInfo = "data source=bd2progra1countries.database.windows.net;initial catalog=Countries;persist security info=True;"+
            "user id=admin1;password=osAf34@fdl4029;MultipleActiveResultSets=True;App=EntityFramework";
